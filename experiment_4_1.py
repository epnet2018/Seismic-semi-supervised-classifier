...
Testing of methods using the dataset of induced earthquakes in northern China
@author: Luozhao Jia
...
if __name__ == '__main__':
    ...
    hd5_test=r'.\\data\\output_data3c_test.h5'
    ...
    Model_Name_Array=['c_model_3200_num_22bb_30','c_model_10401_num_22bb_0412']
    res_array=[]
    res_array1=[]
